...
public class PhoneFormat {
    ...
    public  HashMap<String, ArrayList<String>> getCallingCodeCountries(){
        return callingCodeCountries;
    }
    
    public  HashMap<String, CallingCodeInfo> getCallingCodeInfo(){
        return callingCodeData;
    }
    
    public  HashMap<String, String> getCountryCallingCode(){
    ...
    public void init(String countryCode) {
        ...
        try {
            stream = new FileInputStream("G:\\Android\\Projects\\Telegram-master\\TMessagesProj\\src\\main\\assets\\PhoneFormats.dat");// ApplicationLoader.applicationContext.getAssets().open("PhoneFormats.dat");
